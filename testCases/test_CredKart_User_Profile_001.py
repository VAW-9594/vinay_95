...
class Test_User_Profile_Class:
    ...
    def test_CredKart_Title_001(self):
        ...
        if self.driver.title == "CredKart":
            ...
            self.driver.save_screenshot(
                r"C:\Users\91959\OneDrive\Desktop\Automation testing\CredKart_Pytest_Framework_02\Screenshots\User login Successfully.png"
                )
            allure.attach.file(r"C:\Users\91959\OneDrive\Desktop\Automation testing\CredKart_Pytest_Framework_02\Screenshots\User login Successfully.png", name="User login Successfully", attachment_type=allure.attachment_type.PNG)
            assert True
        else:
            self.log.info("Landed on incorrect page and it's title is: " + self.driver.title)
            self.log.info("Taking screenshot")
            self.driver.save_screenshot(r"C:\Users\91959\OneDrive\Desktop\Automation testing\CredKart_Pytest_Framework_02\Screenshots\User login Failed.png")
            allure.attach.file(r"C:\Users\91959\OneDrive\Desktop\Automation testing\CredKart_Pytest_Framework_02\Screenshots\User login Failed.png", name="User login Failed", attachment_type=allure.attachment_type.PNG)
    ...
    def test_CredKart_Registration_003(self):
        ...
        if self.rp.verify_menu() == "Pass":
            ...
            # self.driver.save_screenshot(r"C:\Users\91959\OneDrive\Desktop\Automation testing\CredKart_Pytest_Framework_02\Screenshots\User login Failed.png\User login Successfully.png")
            ...
            self.log.info("Taking screenshot")
            self.driver.save_screenshot(r"C:\Users\91959\OneDrive\Desktop\Automation testing\CredKart_Pytest_Framework_02\Screenshots\User login Failed.png\User Registration Failed.png")
            assert False
