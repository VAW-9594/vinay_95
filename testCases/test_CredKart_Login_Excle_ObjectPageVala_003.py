...
class Test_Login_Excel_003:
    ...
    def test_CredKart_Login_ExcelObjectPage_003(self):
        ...
        for i in range(2, self.rows + 1):
            ...
            self.email = Excel_utils.read_data_from_excel(self.excel_path, self.sheet_name, i, 2)
            self.password = Excel_utils.read_data_from_excel(self.excel_path, self.sheet_name, i, 3)
            self.expected_result = Excel_utils.read_data_from_excel(self.excel_path, self.sheet_name, i, 4)
            ...
            if self.lp.verify_menu() == "Pass":
                ...
                Excel_utils.write_data_to_excel(self.excel_path, self.sheet_name, i, 5, "Pass")
                ...
                self.log.info("Writing result to excel file")
                Excel_utils.write_data_to_excel(self.excel_path, self.sheet_name, i, 5, "Fail")
                self.log.info("Taking screenshot")
            ...
            self.log.info("Writing result to excel file")
            Excel_utils.write_data_to_excel(self.excel_path, self.sheet_name, i, 6, test_case_status)
            # self.log.info("Opening browser and landing on login page--" + self.login_url)
            # self.driver.get(self.login_url)
