...
class Test_User_Profile_Class:
    ...
    def test_CredKart_Login_params_004(self,get_data_for_login):
        ...
        if self.lp.verify_menu() == "Pass":
            ...
            self.driver.save_screenshot(r"C:\Users\91959\OneDrive\Desktop\Automation testing\CredKart_Pytest_Framework_02\Screenshots\User login Failed.png\User login Failed.png")
